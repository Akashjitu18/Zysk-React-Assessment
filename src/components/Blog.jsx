                    ...
                    <div className="flex flex-wrap gap-6 justify-center">
                        ...
                        <div className="p-4" style={{ width: '384px', height: '444px' }}>
                            <div className="h-full rounded-lg overflow-hidden">
                                ...
                                />
                                <div className="py-2">
                                    <h2 className="tracking-widest text-xs title-font font-medium text-[#6941C6] mb-1">
                                        Design
                                    </h2>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <p className="text-gray-500 text-sm">Nov 20, 2024</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="h-full rounded-lg overflow-hidden">
                                ...
                                <div className="py-2">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        />
                                        <div className="flex-grow">
                                            <h2 className="text-gray-900 title-font font-medium">Jane Smith</h2>
                                            <p className="text-gray-500 text-sm">Nov 19, 2024</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="p-4" style={{ width: '384px', height: '444px' }}>
                            <div className="h-full rounded-lg overflow-hidden">
                                ...
                                <div className="py-2">
                                    ...
                                    <p className=" mb-3 text-sm">
                                        The rise of RESTful APIs has been met by a rise in tools for creating, testing,
                                        and managing them.
                                    </p>
                                    <div className="flex items-center">
                                        <img
                                        ...
                                        />
                                        <div className="flex-grow">
                                            <h2 className="text-gray-900 title-font font-medium">Alice Johnson</h2>
                                            <p className="text-gray-500 text-sm">Nov 18, 2024</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
